...
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).trianglify = t();
}(void 0, function () {
  "use strict";
  ...
  var r = /*#__PURE__*/function () {
    _createClass(r, null, [{
      ...
      value: function from(e) {
        ...
        var a = e.length,
            f = new Float64Array(2 * a);

        for (var _r3 = 0; _r3 < a; _r3++) {
          var _a = e[_r3];
          f[2 * _r3] = t(_a), f[2 * _r3 + 1] = n(_a);
        }
    ...
    function r(e) {
      ...
      var _r2 = Math.max(2 * t - 5, 0);

      this._triangles = new Uint32Array(3 * _r2), this._halfedges = new Int32Array(3 * _r2), this._hashSize = Math.ceil(Math.sqrt(t)), this._hullPrev = new Uint32Array(t), this._hullNext = new Uint32Array(t), this._hullTri = new Uint32Array(t), this._hullHash = new Int32Array(this._hashSize).fill(-1), this._ids = new Uint32Array(t), this._dists = new Float64Array(t), this.update();
    }
    ...
    _createClass(r, [{
      ...
      value: function update() {
        ...
        for (var _e2 = 0; _e2 < u; _e2++) {
          var _r4 = t[2 * _e2],
              _n = t[2 * _e2 + 1];
          _r4 < s && (s = _r4), _n < d && (d = _n), _r4 > h && (h = _r4), _n > b && (b = _n), this._ids[_e2] = _e2;
        }
        ...
        for (var _e3 = 0; _e3 < u; _e3++) {
          var _r5 = n(p, g, t[2 * _e3], t[2 * _e3 + 1]);
        ...
        for (var _e4 = 0; _e4 < u; _e4++) {
          if (_e4 === v) continue;

          var _r6 = n(k, _, t[2 * _e4], t[2 * _e4 + 1]);

          _r6 < w && _r6 > 0 && (y = _e4, w = _r6);
        }
        ...
        for (var _e5 = 0; _e5 < u; _e5++) {
          if (_e5 === v || _e5 === y) continue;

          var _r7 = i(k, _, M, x, t[2 * _e5], t[2 * _e5 + 1]);
        ...
        if (N === 1 / 0) {
          for (var _e7 = 0; _e7 < u; _e7++) {
            this._dists[_e7] = t[2 * _e7] - t[0] || t[2 * _e7 + 1] - t[1];
          }

          c(this._ids, this._dists, 0, u - 1);

          var _e6 = new Uint32Array(u);

          var _r8 = 0;

          for (var _t2 = 0, _n2 = -1 / 0; _t2 < u; _t2++) {
            var _a2 = this._ids[_t2];
            this._dists[_a2] > _n2 && (_e6[_r8++] = _a2, _n2 = this._dists[_a2]);
          }

          return this.hull = _e6.subarray(0, _r8), this.triangles = new Uint32Array(0), void (this.halfedges = new Uint32Array(0));
        }
        ...
        if (f(k, _, M, x, S, P)) {
          var _e8 = y,
              _t3 = M,
              _r9 = x;
          y = m, M = S, x = P, m = _e8, S = _t3, P = _r9;
        }

        var A = function (e, t, r, n, a, f) {
          var o = r - e,
              i = n - t,
              c = a - e,
              l = f - t,
        ...
        for (var _e9 = 0; _e9 < u; _e9++) {
          this._dists[_e9] = n(t[2 * _e9], t[2 * _e9 + 1], A.x, A.y);
        }
        ...
        for (var _n3, _i, _c = 0; _c < this._ids.length; _c++) {
          var _u = this._ids[_c],
              _s = t[2 * _u],
              _d = t[2 * _u + 1];
          if (_c > 0 && Math.abs(_s - _n3) <= e && Math.abs(_d - _i) <= e) continue;
          if (_n3 = _s, _i = _d, _u === v || _u === y || _u === m) continue;
          var _h = 0;

          for (var _e10 = 0, _t4 = this._hashKey(_s, _d); _e10 < this._hashSize && (_h = l[(_t4 + _e10) % this._hashSize], -1 === _h || _h === a[_h]); _e10++) {
            ;
          }
          ...
          for (; _b = a[_p], !f(_s, _d, t[2 * _p], t[2 * _p + 1], t[2 * _b], t[2 * _b + 1]);) {
            if (_p = _b, _p === _h) {
              _p = -1;
              break;
            }
          ...
          var _g = this._addTriangle(_p, _u, a[_p], -1, -1, o[_p]);

          o[_u] = this._legalize(_g + 2), o[_p] = _g, E++;
          var _w = a[_p];

          for (; _b = a[_w], f(_s, _d, t[2 * _w], t[2 * _w + 1], t[2 * _b], t[2 * _b + 1]);) {
            _g = this._addTriangle(_w, _u, _b, o[_u], -1, o[_w]), o[_u] = this._legalize(_g + 2), a[_w] = _w, E--, _w = _b;
          }

          if (_p === _h) for (; _b = r[_p], f(_s, _d, t[2 * _b], t[2 * _b + 1], t[2 * _p], t[2 * _p + 1]);) {
            _g = this._addTriangle(_b, _u, _p, -1, o[_p], o[_b]), this._legalize(_g + 2), o[_b] = _g, a[_p] = _p, E--, _p = _b;
          }
          this._hullStart = r[_u] = _p, a[_p] = r[_w] = _u, a[_u] = _w, l[this._hashKey(_s, _d)] = _u, l[this._hashKey(t[2 * _p], t[2 * _p + 1])] = _p;
        }

        this.hull = new Uint32Array(E);

        for (var _e11 = 0, _t5 = this._hullStart; _e11 < E; _e11++) {
          this.hull[_e11] = _t5, _t5 = a[_t5];
        }
      ...
      key: "_hashKey",
      value: function _hashKey(e, t) {
        return Math.floor(function (e, t) {
          var r = e / (Math.abs(e) + Math.abs(t));
          return (t > 0 ? 3 - r : 1 + r) / 4;
        }(e - this._cx, t - this._cy) * this._hashSize) % this._hashSize;
      }
    }, {
      key: "_legalize",
      value: function _legalize(e) {
        var r = this._triangles,
            n = this._halfedges,
            a = this.coords;
        var f = 0,
            i = 0;
        ...
        for (;;) {
          ...
          if (o(a[2 * _h2], a[2 * _h2 + 1], a[2 * _b2], a[2 * _b2 + 1], a[2 * _p2], a[2 * _p2 + 1], a[2 * _g2], a[2 * _g2 + 1])) {
            r[e] = _g2, r[_c2] = _h2;
            var _a3 = n[_d2];

            if (-1 === _a3) {
              var _t6 = this._hullStart;

              do {
                if (this._hullTri[_t6] === _d2) {
                  this._hullTri[_t6] = e;
                  break;
                }

                _t6 = this._hullPrev[_t6];
              } while (_t6 !== this._hullStart);
            }

            this._link(e, _a3), this._link(_c2, n[i]), this._link(i, _d2);
      ...
      key: "_link",
      value: function _link(e, t) {
        this._halfedges[e] = t, -1 !== t && (this._halfedges[t] = e);
      }
    }, {
      key: "_addTriangle",
      value: function _addTriangle(e, t, r, n, a, f) {
  ...
  function c(e, t, r, n) {
    if (n - r <= 20) for (var _a4 = r + 1; _a4 <= n; _a4++) {
      var _n4 = e[_a4],
          _f = t[_n4];

      var _o2 = _a4 - 1;

      for (; _o2 >= r && t[e[_o2]] > _f;) {
        e[_o2 + 1] = e[_o2--];
      }
      ...
      l(e, r + n >> 1, _a5), t[e[r]] > t[e[n]] && l(e, r, n), t[e[_a5]] > t[e[n]] && l(e, _a5, n), t[e[r]] > t[e[_a5]] && l(e, r, _a5);
      var _o3 = e[_a5],
          _i2 = t[_o3];
      ...
      e[r + 1] = e[_f2], e[_f2] = _o3, n - _a5 + 1 >= _f2 - r ? (c(e, t, _a5, n), c(e, t, r, _f2 - 1)) : (c(e, t, r, _f2 - 1), c(e, t, _a5, n));
    }
  }
  ...
  var d = function (e, t) {
    ...
    e.exports = function () {
      for (var e = function e(_e12, t, r) {
        return void 0 === t && (t = 0), void 0 === r && (r = 1), _e12 < t ? t : _e12 > r ? r : _e12;
      ...
      var M = i.unpack,
        ...
        if (0 === i) n = a = f = 255 * c;else {
          ...
          for (var b = 0; b < 3; b++) {
            l[b] < 0 && (l[b] += 1), l[b] > 1 && (l[b] -= 1), 6 * l[b] < 1 ? u[b] = d + 6 * (s - d) * l[b] : 2 * l[b] < 1 ? u[b] = s : 3 * l[b] < 2 ? u[b] = d + (s - d) * (2 / 3 - l[b]) * 6 : u[b] = d;
          }
        ...
        if (t = e.match(C)) {
          for (var a = t.slice(1, 5), f = 0; f < 4; f++) {
            a[f] = +a[f];
          }
        ...
        if (t = e.match(L)) {
          for (var o = t.slice(1, 4), i = 0; i < 3; i++) {
            o[i] = U(2.55 * o[i]);
          }
        ...
        if (t = e.match(z)) {
          for (var l = t.slice(1, 5), u = 0; u < 3; u++) {
            l[u] = U(2.55 * l[u]);
          }
      ...
      var V = i.unpack,
        ...
        return 0 === l ? r = Number.NaN : (a === c && (r = (f - o) / l), f === c && (r = 2 + (o - a) / l), o === c && (r = 4 + (a - f) / l), (r *= 60) < 0 && (r += 360)), [r, u, s];
          ...
          X = Math.floor,
          J = function J() {
        for (var e, t, r, n, a, f, o = [], i = arguments.length; i--;) {
          o[i] = arguments[i];
        }
      ...
      var ee = i.unpack,
        ...
        var c = (n = re(n)) << 16 | (a = re(a)) << 8 | (f = re(f)),
            l = "000000" + c.toString(16);
      ...
      var Vt = i.clip_rgb,
        ...
        var t = "rgb",
          ...
          l = n ? e : i && i.length > 2 ? function (e) {
            if (null != i) {
              for (var t = i.length - 1, r = 0; r < t && e >= i[r];) {
                r++;
              }
        ...
        return _.classes = function (e) {
          ...
          return null == e && (e = !0), d = e, k(), y = d ? function (e) {
            for (var t = w(0, !0).lab()[0], r = w(1, !0).lab()[0], n = t > r, a = w(e, !0).lab()[0], f = t + (r - t) * e, o = a - f, i = 0, c = 1, l = 20; Math.abs(o) > .01 && l-- > 0;) {
              n && (o *= -1), o < 0 ? (i = e, e += .5 * (c - e)) : (c = e, e += .5 * (i - e)), a = w(e, !0).lab()[0], o = a - f;
            }
          ...
          if (0 === arguments.length) n = c.slice(0);else if (1 === t) n = [_(.5)];else if (t > 1) {
            ...
            e = [];
            var l = [];
            if (i && i.length > 2) for (var u = 1, s = i.length, d = 1 <= s; d ? u < s : u > s; d ? u++ : u--) {
              l.push(.5 * (i[u - 1] + i[u]));
            } else l = a;
            n = l.map(function (e) {
              return _(e);
      ...
      function ar(e, t, r) {
        for (var n = [], a = e < t, f = r ? a ? t + 1 : t - 1 : t, o = e; a ? o < f : o > f; a ? o++ : o--) {
          n.push(o);
        }
      ...
      var fr = function fr(e) {
        ...
        if (2 === (e = e.map(function (e) {
          ...
          return e.lab();
        }), f = r[0], o = r[1], i = r[2], a = function a(e) {
          var t = [0, 1, 2].map(function (t) {
          ...
          n = e.map(function (e) {
            return e.lab();
          }), f = n[0], o = n[1], i = n[2], c = n[3], a = function a(e) {
            var t = [0, 1, 2].map(function (t) {
      ...
      for (var lr = or, ur = i.type, sr = i.clip_rgb, dr = i.TWOPI, hr = Math.pow, br = Math.sin, pr = Math.cos, gr = Math.floor, vr = Math.random, yr = Math.log, mr = Math.pow, wr = Math.floor, kr = Math.abs, _r = function _r(e, t) {
        void 0 === t && (t = null);
        var r = {
        ...
        if ("c" === t.substr(0, 1) && (i.push(n), i.push(a)), "e" === t.substr(0, 1)) {
          ...
          var l = Math.LOG10E * yr(n),
              u = Math.LOG10E * yr(a);
          i.push(n);

          for (var s = 1; s < r; s++) {
            i.push(mr(10, l + s / r * (u - l)));
          }
          ...
          for (_.push(a); w;) {
            ...
            for (var N = 0; N < v; N++) {
              for (var S = o[N], P = Number.MAX_VALUE, A = void 0, E = 0; E < r; E++) {
                var G = kr(_[E] - S);
                G < P && (P = G, A = E), m[A]++, y[N] = A;
              }
            }

            for (var O = new Array(r), R = 0; R < r; R++) {
              O[R] = null;
            }

            for (var j = 0; j < v; j++) {
              null === O[g = y[j]] ? O[g] = o[j] : O[g] += o[j];
            }
          ...
          for (var z = [], I = 0; I < r; I++) {
            z.push(T[I][0]), z.push(T[I][T[I].length - 1]);
          }
      ...
      return p.average = function (e, t, r) {
        ...
        for (var f = e.shift(), o = f.get(t), i = [], c = 0, l = 0, u = 0; u < o.length; u++) {
          if (o[u] = (o[u] || 0) * r[0], i.push(isNaN(o[u]) ? 0 : r[0]), "h" === t.charAt(u) && !isNaN(o[u])) {
            var s = o[u] / 180 * Xt;
        ...
        e.forEach(function (e, n) {
          ...
          for (var f = 0; f < o.length; f++) {
            if (!isNaN(a[f])) if (i[f] += r[n + 1], "h" === t.charAt(f)) {
              var u = a[f] / 180 * Xt;
        ...
        for (var b = 0; b < o.length; b++) {
          if ("h" === t.charAt(b)) {
            for (var p = Qt(l / i[b], c / i[b]) / Xt * 180; p < 0;) {
              p += 360;
            }
        ...
        var i = function i(_i3) {
          var c = dr * ((e + 120) / 360 + t * _i3),
              l = hr(a[0] + f * _i3, n),
              u = (0 !== o ? r[0] + _i3 * o : r) * l * (1 - l) / 2,
              s = pr(c),
              d = br(c);
        ...
        for (var e = "#", t = 0; t < 6; t++) {
          e += "0123456789abcdef".charAt(gr(16 * vr()));
        }
        ...
        for (var a = Array.from(e.lab()), f = a[0], o = a[1], i = a[2], c = Array.from(t.lab()), l = c[0], u = c[1], s = c[2], d = Nr(o * o + i * i), b = Nr(u * u + s * s), p = f < 16 ? .511 : .040975 * f / (1 + .01765 * f), g = .0638 * d / (1 + .0131 * d) + .638, v = d < 1e-6 ? 0 : 180 * Sr(i, o) / Er; v < 0;) {
          v += 360;
        }
  ...
  var p = "undefined" != typeof window && "undefined" != typeof document,
    ...
    var a = n || g.createElementNS("http://www.w3.org/2000/svg", e);
    return Object.keys(t).forEach(function (e) {
      return void 0 !== t[e] && a.setAttribute(e, t[e]);
    ...
    return {
      ...
      toString: function toString() {
        return "<".concat(e, " ").concat(function (e) {
          return Object.entries(e).filter(function (_ref) {
  ...
  var m = function m(e, t, r) {
    ...
    b(this, "_toSVG", function (e, t) {
      ...
      var n = e,
        ...
        coordinateDecimals: 1
          ...
          c = o.width,
          l = o.height,
          u = a.coordinateDecimals < 0 ? f : f.map(function (e) {
        return e.map(function (e) {
          return +e.toFixed(a.coordinateDecimals);
        });
      }),
          s = i.map(function (e) {
        var t = "M" + e.vertexIndices.map(function (e) {
          return "".concat(u[e][0], ",").concat(u[e][1]);
        }).join("L") + "Z",
            r = o.strokeWidth > 0;
        return n("path", {
          d: t,
    ...
    }), b(this, "toSVGTree", function (e) {
      return _this._toSVG(y, null, e);
    }), b(this, "toSVG", p ? function (e, t) {
      return _this._toSVG(v, e, t);
    } : function (e, t) {
      return _this.toSVGTree(t);
    }), b(this, "toCanvas", function (e) {
      var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      ...
      var r = _objectSpread(_objectSpread({}, {
        ...
        applyCssScaling: !!p
          ...
          a = _this.polys,
          f = _this.opts,
          o = e || (i = f.width, c = f.height, Object.assign(document.createElement("canvas"), {
        width: i,
        height: c
      }));
      ...
      if (r.scaling) {
        var _e13 = "auto" === r.scaling ? function (e) {
        ...
        1 !== _e13 ? (o.width = f.width * _e13, o.height = f.height * _e13, r.applyCssScaling && (o.style.width = f.width + "px", o.style.height = f.height + "px")) : (o.width = f.width, o.height = f.height, r.applyCssScaling && (o.style.width = "", o.style.height = "")), l.scale(_e13, _e13);
      }

      var u = function u(e, t, r) {
        var a = e.vertexIndices;
      ...
      return f.fill && f.strokeWidth < 1 && a.forEach(function (e) {
        return u(e, null, {
          color: e.color,
          width: 2
        });
  ...
  function w(e) {
    ...
    var t = function (e) {
      for (var t = 0, r = 1779033703 ^ e.length; t < e.length; t++) {
        r = (r = Math.imul(r ^ e.charCodeAt(t), 3432918353)) << 13 | r >>> 19;
      }
  ...
  var k = function k() {
    ...
    return function (_ref5) {
      var t = _ref5.xPercent,
          r = _ref5.yPercent,
          n = _ref5.xScale,
          a = _ref5.yScale,
          f = _ref5.opts;
      return d.mix(n(t), a(r), e, f.colorSpace);
    };
  };
  ...
  function x() {
    ...
    var t = _objectSpread(_objectSpread({}, M), e);
    ...
    var n = w(t.seed),
      ...
      switch (!0) {
        ...
        case "random" === e:
          return function () {
            if (_instanceof(t.palette, Array)) return t.palette[Math.floor(n() * t.palette.length)];
        ...
        f = a(t.xColors),
        o = "match" === t.yColors ? f : a(t.yColors),
        i = d.scale(f).mode(t.colorSpace),
        c = d.scale(o).mode(t.colorSpace),
        l = t.points || N(t, n);

    var u = r.from(l).triangles;
    var s = w(t.seed ? t.seed + 42 : null),
        h = [];

    for (var _e14 = 0; _e14 < u.length; _e14 += 3) {
      var _r10 = [u[_e14], u[_e14 + 1], u[_e14 + 2]],
          _n5 = _r10.map(function (e) {
        return l[e];
      }),
          _a6 = t.width,
          _f3 = t.height,
        ...
        return Math.max(0, Math.min(1, e));
          ...
          _d3 = {
        x: ((b = _n5)[0][0] + b[1][0] + b[2][0]) / 3,
        y: (b[0][1] + b[1][1] + b[2][1]) / 3
      },
          _p3 = _o4(_d3.x / _a6),
          _g3 = _o4(_d3.y / _f3),
          _v = t.colorFunction({
  ...
  var N = function N(e, t) {
    ...
    return Array(o * i).fill(null).map(function (e, t) {
      var r = t % o,
          n = Math.floor(t / o);
  ...
  return x.utils = {
    mix: d.mix,
    colorbrewer: h
  }, x.colorFunctions = _, x.Pattern = m, x.defaultOptions = M, x;
});